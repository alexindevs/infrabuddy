import { RustGhActionsAnswers } from './../../../interfaces/rust-config.interface';
...
@Injectable()
export class BuildRustGhActionsService {
  ...
  private buildContext(answers: RustGhActionsAnswers): Record<string, any> {
    return {
      ...answers,
