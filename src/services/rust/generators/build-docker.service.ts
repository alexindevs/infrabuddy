...
import { RustDockerAnswers } from '../../../interfaces/rust-config.interface';

@Injectable()
export class BuildRustDockerService {
  ...
  private buildContext(answers: RustDockerAnswers): Record<string, any> {
