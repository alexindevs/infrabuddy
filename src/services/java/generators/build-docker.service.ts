...
import { JavaDockerAnswers } from '../../../interfaces/java-config.interface';

@Injectable()
export class BuildJavaDockerService {
  ...
  private buildContext(answers: JavaDockerAnswers): Record<string, any> {
