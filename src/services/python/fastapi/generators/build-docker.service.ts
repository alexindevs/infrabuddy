...
import { FastAPIDockerAnswers } from '../../../../interfaces/python-config.interface';

@Injectable()
export class BuildFastAPIDockerService {
  ...
  private buildContext(answers: FastAPIDockerAnswers): Record<string, any> {
    const context: Record<string, any> = {
      ...answers,
      use_uvicorn: answers.use_uvicorn,
