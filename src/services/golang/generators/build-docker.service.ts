...
import { GoDockerAnswers } from '../../../interfaces/golang-config.interface';

@Injectable()
export class BuildGoDockerService {
  ...
  private buildContext(answers: GoDockerAnswers): Record<string, any> {
